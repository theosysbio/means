...
In addition, models allow to make testable predictions about the behaviour of the system in response to some stimulus.
In the last few decades, use of mathematical representations of biological interactions has been an increasingly fruitful and wide aspect of biological research.
...
However, it is possible to simulate single realisation of the Chemical Master Equation using \gls{ssa}.
...
This makes the expressions for moments infinitely long, and, the \glspl{ode} impossible to solve analytically. 
...
It is believed that this parametric closure method may approximate the actual values of the closed moments more accurately.
