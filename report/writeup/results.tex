...
For normal and scalar closures, we observe this trend up to maximal moment order of six.
...
Note that for even maximal moment orders, normal and scalar closure methods return identical result.
It means that when the maximal moment order is even,  the parametric expression of an odd (the next) order moment was used for closure.
