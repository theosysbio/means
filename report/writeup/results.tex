...
The number $n$ of modelled moments (\ie{} the number of generated \gls{ode}s), for a system with $s$ species and up to moments of order $o$ is defined by: \quentintodo[inline]{Does not make sense for 3 species, and 2nd-order moments (3+2-2 choose 3) - 1 = 0}
\begin{equation}
n={{s+o-2} \choose {s}} -1
\end{equation}
...
Once the implementation of additional features was done (see \todo{autoref to closure}), we have
endeavoured to see if we could optimise the runtime of the algorithm.
After all, \gls{mea} is designed to be an efficient alternative for stochastic simulations. 
