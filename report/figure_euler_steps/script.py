...
FILE_NAME="../data_euler_steps.pickle"


# #t1s = [d["trajectories"][0] for d in list_of_dict if d["method"] == "MEA_euler"]
# t1s = [d["trajectories"][0] for d in list_of_dict]
# import pylab as pl
# pl.figure()
# for t in t1s:
#     t.plot()
...
class MyFigureA(ReportUnit):
    ...
    def run(self):
        ...
        f, axarr = pl.subplots( n_species, sharex=True, figsize=(9.0, 16.0))
        ...
        for sps, yl in zip(range (n_species), ylims):
            for d in list_of_dict:
                if  d["method"] == "SSA":
                ...
                elif d["method"] == "MEA_vanilla" and d["trajectories"]:
                    ...
                    lwd=1.5
                    alpha=0.5
                    #text="species: y_{0}; max order: {1}".format(sps)
